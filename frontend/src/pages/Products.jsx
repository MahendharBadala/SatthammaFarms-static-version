    ...
    <div className="container mx-auto py-12">
      <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-10">
        <div>
          ...
          <h1 className="font-serif text-5xl sm:text-6xl mt-2 text-ink">Products</h1>
        ...
        <div className="relative w-full md:w-80">
          ...
          <input
            ...
            placeholder="Search corn, pickle, dal..."
      ...
      <div className="flex gap-2 overflow-x-auto no-scrollbar pb-4 mb-6">
        {[{ key: "all", label: "All" }, ...categories].map(c => (
          <button
            ...
            className={`whitespace-nowrap px-5 py-2 rounded-full border text-sm transition-colors ${category === c.key ? "bg-forest text-cream border-forest" : "bg-white text-ink border-edge hover:border-forest"}`}
          >
            {c.label}
          </button>
        ))}
      ...
      {filtered.length === 0 ? (
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5" data-testid="products-grid">
